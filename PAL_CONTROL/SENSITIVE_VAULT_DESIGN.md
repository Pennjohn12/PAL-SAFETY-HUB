...
- Run one showed the accepted scanner eventually classify and move the exact rescan object as clean, but the vault did not expose trusted rescan evidence within the four-minute observation window. Run two extended the fail-closed observation window to ten minutes and still did not receive trusted evidence.
