...
| 6 | Staging | Artifact Registry vulnerability scan for the single measurement image | Console-disclosed price $0.26 per image | $0.26 one time for current image | $0; not enabled | Awaiting specific paid-action approval |
