...
| 6 | Staging | Artifact Registry vulnerability scans for scanner measurement images | Console-disclosed price $0.26 per newly pushed image | $0.26 per newly pushed image; every replacement requires a new charge/approval record | Three scans authorized and incurred: $0.78 total; billing report not yet posted | First image blocked by 17 high findings; second had zero vulnerabilities but a critical package-name collision; renamed third image passed with no vulnerability or malicious-package findings |
