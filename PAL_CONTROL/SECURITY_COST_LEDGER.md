...
| 6 | Staging | Artifact Registry vulnerability scans for scanner measurement images | Console-disclosed price $0.26 per newly pushed image | $0.26 per newly pushed image; every replacement requires a new charge/approval record | Two scans authorized and incurred: $0.52 total; billing report not yet posted | First scanned image blocked by 17 high findings; hardened image had zero vulnerabilities but was blocked by one critical malicious-package name collision; local name remediation cost $0; next $0.26 scan not authorized |
