...
| 6 | Staging | Artifact Registry vulnerability scans for scanner measurement images | Console-disclosed price $0.26 per newly pushed image | $0.26 per newly pushed image; every replacement requires a new charge/approval record | Five scans authorized and incurred: $1.30 total; billing report not yet posted | First blocked by 17 high findings; second blocked by a critical name collision; third scanned clean but failed startup review; startup-fixed fourth and trusted-rescan fifth images passed with no findings |
