...
- The latest observed dashboard amount is **$9.36 for the whole Staging project for Aug. 1–29**, compared with the earlier `$0.52` snapshot. Because it is project-wide and not broken down by SKU, it cannot yet be attributed fully to Package 6 or combined with `$2.34` as an invoice total. This increase requires itemized billing review before a Production proposal.
