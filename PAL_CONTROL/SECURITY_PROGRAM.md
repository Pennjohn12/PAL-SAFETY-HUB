...
- In progress: **Package 6**. Existing scanner, sensitive release/audit, approval, retention, notification, false-positive, legacy, and Office controls passed in isolated Staging. The first-scan/certification candidate now has accepted, undeployed immutable replacement `sha256:dca8aaa4128be626b655766374d4bf10a999d95cbf78e20669fbc1d28031d19d`, using exact-generation authoritative metadata and a private authenticated callback rather than output-bucket authorization. Retry remains invisible to employees, certification release stays simple, and identity keeps stronger rules. Narrow Staging callback/runtime deployment and full lifecycle regressions remain required before billing reconciliation and an exact Production proposal; Production remains closed.
