...
- Package 6 trusted-rescan scanner digest `sha256:ab00939cb01de07150d20ad643dab338feb19fb31f0033049ad4a6f18e457da5` passed Artifact Analysis and is active only in private, min-0/max-1/concurrency-1 Staging. Three false-positive actions, private callback, and narrow identities/IAM are ACTIVE; anonymous boundaries fail closed. Two authenticated synthetic regressions also failed closed because trusted rescan evidence did not reliably reach the vault within four- and ten-minute observation windows; all temporary data was cleaned up. Production and real data remain prohibited; the scanner-to-vault lifecycle must be corrected before live false-positive completion, existing-file planning, billing reconciliation, or a Production proposal.
