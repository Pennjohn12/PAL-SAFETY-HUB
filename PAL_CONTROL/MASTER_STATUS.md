...
- Package 6 trusted-rescan scanner digest `sha256:ab00939cb01de07150d20ad643dab338feb19fb31f0033049ad4a6f18e457da5` passed Artifact Analysis and is active only in private, min-0/max-1/concurrency-1 Staging. Three false-positive actions, private callback, and narrow identities/IAM are ACTIVE; anonymous boundaries fail closed. The authenticated two-person false-positive release remains unverified. Production and real data remain prohibited; live false-positive completion, existing-file planning, billing reconciliation, and Production remain open.
...
- Package 6 of 15, sensitive vault and safe release: **In progress / scanner, signed-download, two-person approval, live audit-chain, dedicated identity, retention, legal-hold, deletion, and internal-notification gates passed** on 2026-08-29. The accepted no-finding scanner runs privately against four isolated buckets and passed clean/quarantine, size, duplicate-generation, definition schedule, memory, timeout recovery, and malformed-event tests. Three vault callables and the hourly retention worker use a dedicated zero-key least-privilege identity. Synthetic tests passed concurrent reads, different-person approval, exact fake-file download, linked/redacted audit, exact-generation deletion after the 24-hour/30-day windows, legal-hold and recent-review retention, internal authorized notifications with external delivery disabled, and complete cleanup. The approved false-positive policy, three actions, private callback, narrow IAM, and exact no-finding scanner digest are active in isolated Staging; only the authenticated scanner-to-vault handoff and different-person human release regression remain pending. Remaining gates are live false-positive completion, existing-file planning, cost reconciliation, and an exact Production proposal. No Production or real-data action occurred.
