...
- Package 6 authenticated first-scan candidate digest `sha256:0de3ddbb8fb983e066f8a4b3bec16dd4ed5b34df78e74c7ee9b24ed73b5ca4e8` passed Artifact Analysis but failed its synthetic Staging integration: the exact envelope reached isolated storage and ClamAV returned CLEAN, yet the scanner runtime treated callback metadata as incomplete. The file stayed locked and the deployment was rolled back to prior accepted digest `sha256:ab00939c...`; callback access was removed and retry paused. A corrected, newly scanned image and full synthetic regressions remain required. Production and real data remain prohibited.
...
- Package 6 of 15, sensitive vault and safe release: **In progress / corrected first-scan image accepted but undeployed** on 2026-08-29. Existing sensitive release/audit, approval, retention, notification, false-positive, legacy, and Office gates remain credited. The prior first-scan deployment failed closed and was rolled back. Its metadata defect was corrected and independently reviewed; immutable replacement `sha256:dca8aaa4128be626b655766374d4bf10a999d95cbf78e20669fbc1d28031d19d` passed Artifact Analysis with no vulnerability or malicious-package findings but remains undeployed. Required next gates are separately approved narrow Staging runtime/IAM deployment, the full certification/payroll regression matrix, posted billing reconciliation, and only then an exact Production proposal/approval. No Production or real-data action occurred.
