...
Package 4 treatment for `PAL-SEC-004` passed isolated PAL tests on 2026-08-29 and is live only in Staging. The Production risk remains open until John approves the exact Production cutover and legacy-link replacement impact recorded in `PUBLIC_INTAKE_SECURITY_V2.md`.
