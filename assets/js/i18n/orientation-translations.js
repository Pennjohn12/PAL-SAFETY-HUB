export const PAL_ORIENTATION_TRANSLATIONS = {
  "en": {
    ...
    "moduleCopy": "Watch the complete orientation video, then answer all five quiz questions. You need at least 3 correct answers to continue. A score of 0, 1, or 2 requires you to watch the complete video again before another attempt.",
  ...
  "es": {
    ...
    "moduleCopy": "Mire el video completo de orientación y luego conteste las cinco preguntas. Necesita por lo menos 3 respuestas correctas para continuar. Si obtiene 0, 1 o 2 respuestas correctas, deberá volver a mirar el video completo antes de intentarlo otra vez.",
    ...
    "questions": [
      {
        ...
        "answers": [
          "Zawsze, gdy widać pył",
          "Po wymaganej zgodzie medycznej, teście dopasowania, szkoleniu i upoważnieniu",
          "Gdy współpracownik ma dodatkowy respirator",
          "Dopiero po rozpoczęciu zmiany"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "answers": [
          "Powąchać go, aby rozpoznać zawartość",
          "Użyć ostrożnie i oznaczyć później",
          "Nie używać; odizolować go i powiadomić przełożonego",
          "Przelać do innego pojemnika"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "answers": [
          "Wejść na chwilę, aby sprawdzić, czy wygląda bezpiecznie",
          "Wejść tylko wtedy, gdy jesteś specjalnie przeszkolony, upoważniony i pracujesz zgodnie z wymaganą procedurą",
          "Poprosić współpracownika, aby poczekał na zewnątrz",
          "Założyć maskę przeciwpyłową i wejść"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "answers": [
          "Pod koniec tygodnia",
          "Tylko gdy potrzebne jest leczenie",
          "Natychmiast, nawet jeśli wydaje się drobne",
          "Tylko gdy uszkodzono mienie"
        ],
        "correct": 2,
