...
export const approveSensitiveFalsePositiveReviewV1Callable = httpsCallable(functions, "approveSensitiveFalsePositiveReviewV1");
export const listSensitiveVaultApprovalsV1Callable = httpsCallable(functions, "listSensitiveVaultApprovalsV1");
